...
namespace CSharp.StackExchange.Api.Interfaces
{
	/// <summary>
	/// Interface specifying a basic set of operations for interacting with StackExchange.
	/// </summary>
	/// <author>Scott Smith</author>
    public interface IStackExchange : IApiBinding
    {
		/// <summary>
